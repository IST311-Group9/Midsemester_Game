...
public class RoomTest {
    ...
    public RoomTest() {
        ...
        Person joe = new Person("Joe","Schmoe",false,IST210);
        Person arthur = new Person("Arthur","Zhang",true,IST210);
    ...
    public void testAddPerson() {
        ...
        Room instance = new Room("IST210",210);
        Person personToAdd = new Person("Arthur","Zhang",true,instance);
